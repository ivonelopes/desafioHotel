...
public class MenuPrincipal extends JFrame {
	...
	public MenuPrincipal() {
		...
		JLabel lblCopyR = new JLabel("Atualizado por Ivone Lopes da Silva© 2022");
		...
		btnexit.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				int resposta = JOptionPane.showConfirmDialog(null, "Confirme para sair?");
				if (JOptionPane.OK_OPTION == resposta) {
					//System.out.println("resposta positiva");
					System.exit(0);
				} 
				//JOptionPane.showConfirmDialog(btnexit, "confirma?");
				//System.exit(0);
			}
			@Override
